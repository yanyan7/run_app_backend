    ...
    class ResultsController < ApplicationController
      ...
      def make_index_data
        ...
        results = Result.joins(
          ...
          concat(results.time_h, ':', RIGHT(concat('0',results.time_m), 2), ':', RIGHT(concat('0',results.time_s), 2)) AS time,
          -- concat(results.pace_m, ':', results.pace_s) AS pace,
          concat(results.pace_m, ':', RIGHT(concat('0',results.pace_s), 2)) AS pace,
          results.place,
          results.shoes,
